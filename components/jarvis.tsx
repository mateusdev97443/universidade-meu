...
export function Jarvis() {
  ...
  const [resposta, setResposta] = useState("Olá! Sou o Jarvis com Gemini. Pergunte sobre front-end!");
  ...
  const fazerPergunta = async () => {
    ...
    try {
      ...
      setResposta(data.reply || "Não consegui responder.");
    } catch {
  ...
  return (
    <div className="bg-obsidian-card border border-border rounded-xl p-5">
      <h3 className="text-xl font-semibold flex items-center gap-2 mb-3">
        <span className="text-eletric">🧠 Jarvis IA (Gemini – gratuito)</span>
      </h3>
